...
<div class="container">
    ...
    <div class="test-grid">
        ...
        <div class="test-card">
            ...
            <a href ="quantitative"><button>Start Test</button></a>
        </div>
        ...
        <div class="test-card">
            ...
            <a href ="logical"><button>Resume</button></a>
        </div>
        ...
        <div class="test-card">
            ...
            <a href = "verbal"><button>View Result</button></a>
        </div>
        ...
        <div class="test-card">
            ...
            <a href ="mixed"><button>Start Test</button></a>
        </div>
